...
def draw_bboxes(img, bbox, identities=None, offset=(0,0)):
    for i,box in enumerate(bbox):
        ...
        cv2.rectangle(img,(x1, y1),(x1+t_size[0]+3,y1+t_size[1]+4), color,-1)
        cv2.putText(img,label,(x1,y1+t_size[1]+4), cv2.FONT_HERSHEY_PLAIN, 2, [255,255,255], 4)
        cv2.putText(img,box_area,(x1,y1+40), cv2.FONT_HERSHEY_PLAIN, 1, [255,255,255], 2) #area
    return img
